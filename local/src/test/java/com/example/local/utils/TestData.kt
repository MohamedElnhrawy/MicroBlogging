...
class TestData {
    ...
    companion object {
        fun generateAuthorItems() : List<AuthorLocalModel> {
            ...
            val item2 =  AuthorLocalModel(2, "Mohamed", "Mohamed Alnahrawy","mohamedelnhrawy64@gmail.com","image")
            val item3 = AuthorLocalModel(3, "Mohamed", "Mohamed Alnahrawy","mohamedelnhrawy64@gmail.com","image")
