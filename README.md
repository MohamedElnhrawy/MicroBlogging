...
This is a client app for Shahry new micro blogging platform & basic code that demonstrate how to build an Android application using the Uncle Bob's Clean Architecture approach.
